...
import { TESTIMONIALS_DATA, whatsappLink } from "../data/coachingData";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="flex flex-col items-center text-center max-w-3xl mx-auto mb-10">
          ...
          <h2 className="font-display font-black text-3xl sm:text-5xl uppercase tracking-tight text-white">
            Deportistas que{" "}
            <span className="text-brand-yellow">Confían en el Proceso</span>
          </h2>

          <p className="mt-4 text-base sm:text-lg text-zinc-300">
            Una selección de los atletas que entrenan su mente y potencian su
          ...
          >
            {TESTIMONIALS_DATA.map((player, idx) => {
              ...
              return (
                ...
                >
                  <span
                    className={`w-2 h-2 rounded-full ${isActive ? "bg-black" : "bg-brand-yellow"}`}
                  />
        ...
        >
          ...
          <div className="rounded-3xl p-1 bg-gradient-to-r from-brand-yellow/50 via-zinc-800 to-brand-yellow/30 shadow-2xl transition-all duration-300">
            <div className="rounded-[22px] bg-[#0E0E13] border border-zinc-800 overflow-hidden">
              <div className="grid grid-cols-1 lg:grid-cols-12 items-stretch min-h-[440px] lg:h-[500px]">
                ...
                <div className="lg:col-span-7 p-6 sm:p-10 lg:p-12 flex flex-col justify-between space-y-4 lg:h-full overflow-hidden">
                  ...
                  {/* Testimonio real del jugador (si existe) */}
                  ...
                  {/* Panel informativo cuando no hay testimonio: voz del sitio, misma geometria para no dejar huecos */}
                  {!currentTestimonial.quote && (
                    <div className="relative pl-6 sm:pl-8 border-l-4 border-brand-yellow/60 py-2 my-auto min-h-[100px] flex items-center">
                      <Users className="w-8 h-8 text-brand-yellow/20 absolute -top-4 -left-2 pointer-events-none" />
                      <p className="text-base sm:text-lg text-zinc-300 font-medium leading-relaxed">
                        Forma parte de los deportistas que entrenan su mente y
                        potencian su rendimiento día a día.
                      </p>
                    </div>
                  )}
          ...
          <div className="mt-6 flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-3 text-xs text-zinc-400 font-semibold">
              ...
              <span>
                {currentIndex + 1} de {total} deportistas
              </span>
            </div>
          </div>
        </div>
        ...
        <div className="mt-14 p-6 sm:p-8 rounded-3xl bg-gradient-to-r from-[#121218] via-[#161622] to-[#121218] border border-zinc-800 flex flex-col sm:flex-row items-center justify-between gap-6 text-center sm:text-left">
          <div>
            ...
            <p className="text-xs sm:text-sm text-zinc-400 mt-1 max-w-2xl">
              Estos son solo algunos de los deportistas que forman parte del
              proceso en diferentes ligas y disciplinas.
            </p>
          </div>

          <a
            href={whatsappLink(
              "Hola Nico, vi los testimonios en la web y me gustaría consultar por mi disciplina y objetivos.",
            )}
            target="_blank"
