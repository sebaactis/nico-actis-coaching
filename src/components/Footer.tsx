    ...
    <footer className="bg-[#050507] border-t border-brand-border py-16 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 pb-12 border-b border-zinc-800">
          ...
          <div className="md:col-span-5 space-y-4">
            ...
            <p className="text-xs sm:text-sm text-zinc-400 max-w-sm leading-relaxed">
              Acompañamiento integral para deportistas profesionales y de alto rendimiento. Desarrollá recursos mentales y emocionales para alcanzar tu máximo nivel.
            </p>
          ...
          <div className="md:col-span-3 space-y-3">
            ...
            <ul className="space-y-2 text-xs font-semibold text-zinc-400">
              <li><a href="#inicio" className="hover:text-brand-yellow transition-colors">Inicio</a></li>
              <li><a href="#sobre-mi" className="hover:text-brand-yellow transition-colors">¿Quién Soy y Misión?</a></li>
              <li><a href="#metodologia" className="hover:text-brand-yellow transition-colors">Metodología de Trabajo</a></li>
              <li><a href="#certificaciones" className="hover:text-brand-yellow transition-colors">Certificaciones</a></li>
              <li><a href="#testimonios" className="hover:text-brand-yellow transition-colors">Testimonios</a></li>
              <li><a href="#faq" className="hover:text-brand-yellow transition-colors">Preguntas Frecuentes</a></li>
            </ul>
          </div>
          ...
          <div className="md:col-span-4 space-y-4">
            ...
            <div className="space-y-2 text-xs text-zinc-400">
              <p><strong className="text-zinc-200">Modalidad:</strong> {COACH_INFO.location}</p>
              <p><strong className="text-zinc-200">Email:</strong> {COACH_INFO.email}</p>
            </div>
            ...
            <div className="flex items-center gap-3 pt-2">
              ...
              <a
                href={`https://wa.me/${COACH_INFO.whatsappNumber}`}
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-xl bg-[#14141A] border border-zinc-800 flex items-center justify-center text-zinc-300 hover:text-brand-yellow hover:border-brand-yellow transition-all"
                aria-label="WhatsApp"
        ...
        <div className="pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-zinc-500">
          <p>© {new Date().getFullYear()} Nico Actis Coaching. Todos los derechos reservados.</p>
