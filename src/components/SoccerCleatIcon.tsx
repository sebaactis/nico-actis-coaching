...
interface SoccerCleatIconProps {
  className?: string;
}

/**
 * Soccer cleat (botín de fútbol) icon.
 * Path from Material Design Icons (Apache-2.0): "shoe-cleat".
 */
export const SoccerCleatIcon: React.FC<SoccerCleatIconProps> = ({
  className,
}) => (
  <svg
    viewBox="0 0 24 24"
