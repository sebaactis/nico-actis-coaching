...
export const Hero: React.FC = () => {
  return (
    <section
      id="inicio"
      className="relative min-h-screen pt-32 pb-20 flex flex-col justify-center overflow-hidden bg-[#070708] bg-hero-pattern"
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col items-start text-left space-y-6">
            ...
            <p className="text-lg sm:text-xl text-zinc-300 max-w-2xl font-normal leading-relaxed">
              ...
              rendimiento. Fortalecé tus recursos mentales y emocionales para
            ...
            <div className="w-full max-w-2xl p-4 sm:p-5 rounded-2xl bg-[#111115] border-l-4 border-brand-yellow border-t border-r border-b border-brand-border">
              <p className="text-sm sm:text-base font-semibold text-zinc-200 italic">
                “Porque antes que deportistas, somos personas. El deportista
                puede ser quien compite, pero la persona es quien vive todo el
                proceso.”
              </p>
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 pt-4 w-full sm:w-auto">
              ...
              >
                ...
                <SoccerCleatIcon className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
              </a>
        ...
        <div className="mt-20 pt-10 border-t border-brand-border grid grid-cols-2 md:grid-cols-4 gap-6">
          {COACH_INFO.stats.map((stat, i) => (
            <div
              key={i}
              className="flex flex-col items-center sm:items-start p-4 rounded-xl bg-[#101014] border border-zinc-800/80 hover:border-brand-yellow/40 transition-colors"
            >
